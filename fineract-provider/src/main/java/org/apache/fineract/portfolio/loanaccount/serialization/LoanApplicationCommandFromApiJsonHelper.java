...
public final class LoanApplicationCommandFromApiJsonHelper {
  ...
  public void validateForCreate(final String json,
    ...
    this.fromApiJsonHelper.checkForUnsupportedParameters(
        typeOfMap, json, this.supportedParameters);
    ...
    final String loanTypeStr = this.fromApiJsonHelper.extractStringNamed(
        loanTypeParameterName, element);
    ...
    if (!StringUtils.isBlank(loanTypeStr)) {
      ...
      if (loanType.isJLGAccount()) {
        ...
        if (isMeetingMandatoryForJLGLoans) {
          ...
          final Long calendarId = this.fromApiJsonHelper.extractLongNamed(
    ...
    if (this.fromApiJsonHelper.parameterExists(accountNoParameterName,
                                               element)) {
      final String accountNo = this.fromApiJsonHelper.extractStringNamed(
          accountNoParameterName, element);
      baseDataValidator.reset()
    ...
    if (this.fromApiJsonHelper.parameterExists(externalIdParameterName,
                                               element)) {
      final String externalId = this.fromApiJsonHelper.extractStringNamed(
          externalIdParameterName, element);
      baseDataValidator.reset()
    ...
    if (this.fromApiJsonHelper.parameterExists(fundIdParameterName, element)) {
      final Long fundId =
          this.fromApiJsonHelper.extractLongNamed(fundIdParameterName, element);
      baseDataValidator.reset()
    ...
    if (this.fromApiJsonHelper.parameterExists(loanOfficerIdParameterName,
                                               element)) {
      final Long loanOfficerId = this.fromApiJsonHelper.extractLongNamed(
          loanOfficerIdParameterName, element);
      baseDataValidator.reset()
    ...
    if (this.fromApiJsonHelper.parameterExists(loanPurposeIdParameterName,
                                               element)) {
      final Long loanPurposeId = this.fromApiJsonHelper.extractLongNamed(
          loanPurposeIdParameterName, element);
      baseDataValidator.reset()
    ...
    final BigDecimal principal =
        this.fromApiJsonHelper.extractBigDecimalWithLocaleNamed("principal",
                                                                element);
    baseDataValidator.reset()
        .parameter("principal")
        .value(principal)
    ...
    final String repaymentEveryFrequencyTypeParameterName =
    ...
    CalendarUtils.validateNthDayOfMonthFrequency(
        baseDataValidator, repaymentFrequencyNthDayTypeParameterName,
    ...
    final String interestCalculationPeriodTypeParameterName =
    ...
    if (loanProduct.isLinkedToFloatingInterestRate()) {
      ...
      if (this.fromApiJsonHelper.parameterExists("interestRatePerPeriod",
                                                 element)) {
        baseDataValidator.reset()
      ...
      if (interestType != null &&
          interestType.equals(InterestMethod.FLAT.getValue())) {
        baseDataValidator.reset()
            .parameter(interestTypeParameterName)
            .failWithCode(
    ...
    final Integer graceOnArrearsAgeing =
        this.fromApiJsonHelper.extractIntegerWithLocaleNamed(
            ...
            element);
    baseDataValidator.reset()
        .parameter(LoanProductConstants.GRACE_ON_ARREARS_AGEING_PARAMETER_NAME)
        .value(graceOnArrearsAgeing)
        .zeroOrPositiveAmount();

    final String interestChargedFromDateParameterName =
    ...
    final String repaymentsStartingFromDateParameterName =
    ...
    if (this.fromApiJsonHelper.parameterExists(inArrearsToleranceParameterName,
                                               element)) {
    ...
    final LocalDate submittedOnDate =
        this.fromApiJsonHelper.extractLocalDateNamed(
            submittedOnDateParameterName, element);
    ...
    if (this.fromApiJsonHelper.parameterExists(submittedOnNoteParameterName,
                                               element)) {
      final String submittedOnNote = this.fromApiJsonHelper.extractStringNamed(
          submittedOnNoteParameterName, element);
      baseDataValidator.reset()
    ...
    final String transactionProcessingStrategyIdParameterName =
    ...
    if (this.fromApiJsonHelper.parameterExists(linkAccountIdParameterName,
                                               element)) {
      final Long linkAccountId = this.fromApiJsonHelper.extractLongNamed(
          linkAccountIdParameterName, element);
      baseDataValidator.reset()
    ...
    if (element.isJsonObject() &&
      ...
      final String dateFormat =
          this.fromApiJsonHelper.extractDateFormatParameter(
              topLevelJsonElement);
      final Locale locale =
      ...
      if (topLevelJsonElement.get(chargesParameterName).isJsonArray()) {
        ...
        final Set<String> supportedParameters = new HashSet<>(
            Arrays.asList("id", "chargeId", "amount", "chargeTimeType",
        ...
        for (int i = 1; i <= array.size(); i++) {
          ...
          final JsonObject loanChargeElement =
              array.get(i - 1).getAsJsonObject();
          final String arrayObjectJson =
              this.fromApiJsonHelper.toJson(loanChargeElement);
          this.fromApiJsonHelper.checkForUnsupportedParameters(
              arrayObjectParameterTypeOfMap, arrayObjectJson,
              supportedParameters);

          final Long chargeId = this.fromApiJsonHelper.extractLongNamed(
              "chargeId", loanChargeElement);
          baseDataValidator.reset()
              .parameter("charges")
          ...
          final BigDecimal amount =
              this.fromApiJsonHelper.extractBigDecimalNamed(
                  "amount", loanChargeElement, locale);
          baseDataValidator.reset()
              .parameter("charges")
    ...
    if (element.isJsonObject() && this.fromApiJsonHelper.parameterExists(
                                      collateralParameterName, element)) {
      final JsonObject topLevelJsonElement = element.getAsJsonObject();
      final Locale locale =
          this.fromApiJsonHelper.extractLocaleParameter(topLevelJsonElement);
      if (topLevelJsonElement.get("collateral").isJsonArray()) {

        final Type collateralParameterTypeOfMap =
            new TypeToken<Map<String, Object>>() {}.getType();
        ...
        for (int i = 1; i <= array.size(); i++) {
          ...
          this.fromApiJsonHelper.checkForUnsupportedParameters(
              collateralParameterTypeOfMap, collateralJson,
              supportedParameters);

          final Long collateralTypeId = this.fromApiJsonHelper.extractLongNamed(
              "type", collateralItemElement);
          baseDataValidator.reset()
          ...
          final BigDecimal collateralValue =
              this.fromApiJsonHelper.extractBigDecimalNamed(
                  "value", collateralItemElement, locale);
          baseDataValidator.reset()
              .parameter("collateral")
          ...
          final String description = this.fromApiJsonHelper.extractStringNamed(
              "description", collateralItemElement);
          baseDataValidator.reset()
              .parameter("collateral")
        ...
        baseDataValidator.reset()
            .parameter(collateralParameterName)
            .expectedArrayButIsNot();
      }
    }
    ...
    if (this.fromApiJsonHelper.parameterExists(
      ...
      if (isEqualAmortization) {
        throw new EqualAmortizationUnsupportedFeatureException("fixed.emi",
                                                               "fixed emi");
      }
    ...
    if (loanProduct.canUseForTopup()) {
      if (this.fromApiJsonHelper.parameterExists(LoanApiConstants.isTopup,
                                                 element)) {
        final Boolean isTopup = this.fromApiJsonHelper.extractBooleanNamed(
            LoanApiConstants.isTopup, element);
        baseDataValidator.reset()
        ...
        if (isTopup != null && isTopup) {
          final Long loanId = this.fromApiJsonHelper.extractLongNamed(
              LoanApiConstants.loanIdToClose, element);
          baseDataValidator.reset()
    ...
    if (this.fromApiJsonHelper.parameterExists(LoanApiConstants.datatables,
                                               element)) {
      final JsonArray datatables = this.fromApiJsonHelper.extractJsonArrayNamed(
          LoanApiConstants.datatables, element);
      baseDataValidator.reset()
  ...
  public void validateForModify(final String json,
    ...
    if (this.fromApiJsonHelper.parameterExists(clientIdParameterName,
      ...
      final Long clientId = this.fromApiJsonHelper.extractLongNamed(
          clientIdParameterName, element);
      baseDataValidator.reset()
    ...
    if (this.fromApiJsonHelper.parameterExists(groupIdParameterName, element)) {
      atLeastOneParameterPassedForUpdate = true;
      final Long groupId = this.fromApiJsonHelper.extractLongNamed(
          groupIdParameterName, element);
      baseDataValidator.reset()
    ...
    if (this.fromApiJsonHelper.parameterExists(productIdParameterName,
                                               element)) {
      atLeastOneParameterPassedForUpdate = true;
      final Long productId = this.fromApiJsonHelper.extractLongNamed(
          productIdParameterName, element);
      baseDataValidator.reset()
    ...
    boolean isEqualAmortization =
        existingLoanApplication.getLoanProductRelatedDetail()
            .isEqualAmortization();
    if (this.fromApiJsonHelper.parameterExists(
      ...
      isEqualAmortization = this.fromApiJsonHelper.extractBooleanNamed(
          LoanProductConstants.IS_EQUAL_AMORTIZATION_PARAM, element);
      baseDataValidator.reset()
          .parameter(LoanProductConstants.IS_EQUAL_AMORTIZATION_PARAM)
          .value(isEqualAmortization)
          .ignoreIfNull()
          .validateForBooleanValue();
      if (isEqualAmortization && loanProduct.isInterestRecalculationEnabled()) {
    ...
    if (this.fromApiJsonHelper.parameterExists(principalParameterName,
                                               element)) {
      atLeastOneParameterPassedForUpdate = true;
      principal = this.fromApiJsonHelper.extractBigDecimalWithLocaleNamed(
          principalParameterName, element);
      baseDataValidator.reset()
    ...
    final String loanTermFrequencyParameterName = "loanTermFrequency";
    if (this.fromApiJsonHelper.parameterExists(loanTermFrequencyParameterName,
                                               element)) {
      atLeastOneParameterPassedForUpdate = true;
      final Integer loanTermFrequency =
          this.fromApiJsonHelper.extractIntegerWithLocaleNamed(
    ...
    final String numberOfRepaymentsParameterName = "numberOfRepayments";
    if (this.fromApiJsonHelper.parameterExists(numberOfRepaymentsParameterName,
                                               element)) {
      atLeastOneParameterPassedForUpdate = true;
      final Integer numberOfRepayments =
          this.fromApiJsonHelper.extractIntegerWithLocaleNamed(
    ...
    final String repaymentEveryParameterName = "repaymentEvery";
    if (this.fromApiJsonHelper.parameterExists(repaymentEveryParameterName,
                                               element)) {
      atLeastOneParameterPassedForUpdate = true;
      final Integer repaymentEvery =
          this.fromApiJsonHelper.extractIntegerWithLocaleNamed(
    ...
    if (this.fromApiJsonHelper.parameterExists(repaymentEveryTypeParameterName,
                                               element)) {
      atLeastOneParameterPassedForUpdate = true;
      final Integer repaymentEveryType =
          this.fromApiJsonHelper.extractIntegerWithLocaleNamed(
    ...
    if (this.fromApiJsonHelper.parameterExists(interestTypeParameterName,
                                               element)) {
      atLeastOneParameterPassedForUpdate = true;
      interestType = this.fromApiJsonHelper.extractIntegerWithLocaleNamed(
          interestTypeParameterName, element);
      baseDataValidator.reset()
          .parameter(interestTypeParameterName)
          .value(interestType)
    ...
    if (loanProduct.isLinkedToFloatingInterestRate()) {
      ...
      if (interestType == null) {
        interestType = existingLoanApplication.getLoanProductRelatedDetail()
                           .getInterestMethod()
                           .getValue();
      }
      if (interestType != null &&
      ...
      BigDecimal interestRateDifferential =
          existingLoanApplication.getInterestRateDifferential();
      if (this.fromApiJsonHelper.parameterExists(
              interestRateDifferentialParameterName, element)) {
    ...
    final String amortizationTypeParameterName = "amortizationType";
    if (this.fromApiJsonHelper.parameterExists(amortizationTypeParameterName,
                                               element)) {
      atLeastOneParameterPassedForUpdate = true;
      final Integer amortizationType =
          this.fromApiJsonHelper.extractIntegerWithLocaleNamed(
    ...
    // grace validation
    if (this.fromApiJsonHelper.parameterExists("graceOnPrincipalPayment",
                                               element)) {
      final Integer graceOnPrincipalPayment =
          this.fromApiJsonHelper.extractIntegerWithLocaleNamed(
              "graceOnPrincipalPayment", element);
    ...
    if (this.fromApiJsonHelper.parameterExists("graceOnInterestPayment",
                                               element)) {
      final Integer graceOnInterestPayment =
          this.fromApiJsonHelper.extractIntegerWithLocaleNamed(
              "graceOnInterestPayment", element);
    ...
    if (this.fromApiJsonHelper.parameterExists("graceOnInterestCharged",
                                               element)) {
      final Integer graceOnInterestCharged =
          this.fromApiJsonHelper.extractIntegerWithLocaleNamed(
              "graceOnInterestCharged", element);
    ...
    final String submittedOnDateParameterName = "submittedOnDate";
    if (this.fromApiJsonHelper.parameterExists(submittedOnDateParameterName,
                                               element)) {
      atLeastOneParameterPassedForUpdate = true;
      final LocalDate submittedOnDate =
          this.fromApiJsonHelper.extractLocalDateNamed(
    ...
    if (this.fromApiJsonHelper.parameterExists(syncDisbursementParameterName,
                                               element)) {
      final Boolean syncDisbursement =
          this.fromApiJsonHelper.extractBooleanNamed(
              syncDisbursementParameterName, element);
    ...
    if (meetingIdRequired || this.fromApiJsonHelper.parameterExists(
                                 calendarIdParameterName, element)) {
      final Long calendarId = this.fromApiJsonHelper.extractLongNamed(
          calendarIdParameterName, element);
      baseDataValidator.reset()
  ...
  public void validateForUndo(final String json) {
    ...
    final Set<String> undoSupportedParameters =
        new HashSet<>(Arrays.asList("note"));
    final Type typeOfMap = new TypeToken<Map<String, Object>>() {}.getType();
    this.fromApiJsonHelper.checkForUnsupportedParameters(
        typeOfMap, json, undoSupportedParameters);
  ...
  public void validateMinMaxConstraintValues(final JsonElement element,
                                             final LoanProduct loanProduct) {
    ...
    final BigDecimal minPrincipal =
        loanProduct.getMinPrincipalAmount().getAmount();
    final BigDecimal maxPrincipal =
        loanProduct.getMaxPrincipalAmount().getAmount();
    final String principalParameterName = "principal";
  ...
  public void validateLoanTermAndRepaidEveryValues(
    ...
    this.apiJsonHelper.validateSelectedPeriodFrequencyTypeIsTheSame(
        dataValidationErrors, loanTermFrequency, loanTermFrequencyType,
        numberOfRepayments, repaymentEvery, repaymentEveryType);

    /**
     * For multi-disbursal loans where schedules are auto-generated based on a
     *fixed EMI, ensure the number of repayments is within the permissible range
     *defined by the loan product
     **/
    if (loan.getFixedEmiAmount() != null) {
      Integer minimumNoOfRepayments =
          loan.loanProduct().getMinNumberOfRepayments();
      Integer maximumNoOfRepayments =
          loan.loanProduct().getMaxNumberOfRepayments();
      Integer actualNumberOfRepayments =
          loan.getLoanRepaymentScheduleInstallmentsSize();
  ...
  public void validatelinkedSavingsAccount(final SavingsAccount savingsAccount,
    ...
    if (savingsAccount.isNotActive()) {
      ...
      dataValidationErrors.add(error);
    } else if (!loanApplication.getClientId().equals(
      ...
      for (int i = 0; i < variationArray.size(); i++) {
        ...
        if (jsonObject1.has(LoanApiConstants.disbursementDateParameterName)) {
          LocalDate date1 = this.fromApiJsonHelper.extractLocalDateNamed(
              LoanApiConstants.disbursementDateParameterName, jsonObject1,
              dateFormat, locale);

          for (int j = i + 1; j < variationArray.size(); j++) {
            final JsonObject jsonObject2 =
                variationArray.get(j).getAsJsonObject();
            if (jsonObject2.has(
                    LoanApiConstants.disbursementDateParameterName)) {
              LocalDate date2 = this.fromApiJsonHelper.extractLocalDateNamed(
                  LoanApiConstants.disbursementDateParameterName, jsonObject2,
                  dateFormat, locale);
      ...
      if (variationArray != null && variationArray.size() > 0) {
        ...
        do {
          ...
          baseDataValidator.reset()
              ...
              .parameterAtIndexArray(
                  LoanApiConstants.disbursementDateParameterName, i)
              .value(expectedDisbursementDate)
              .notNull();
          ...
          BigDecimal principal = this.fromApiJsonHelper.extractBigDecimalNamed(
              LoanApiConstants.disbursementPrincipalParameterName, jsonObject,
              locale);
          baseDataValidator.reset()
              .parameter(LoanApiConstants.disbursementDataParameterName)
              .parameterAtIndexArray(
                  LoanApiConstants.disbursementPrincipalParameterName, i)
              .value(principal)
              .notBlank();
          if (principal != null) {
        ...
        if (tatalDisbursement.compareTo(totalPrincipal) > 0) {
          baseDataValidator.reset()
              ...
              .failWithCode(LoanApiConstants
                                .APPROVED_AMOUNT_IS_LESS_THAN_SUM_OF_TRANCHES);
        }
        final String interestTypeParameterName = "interestType";
        final Integer interestType =
            this.fromApiJsonHelper.extractIntegerSansLocaleNamed(
  ...
  public void
  validateLoanCharges(final Set<LoanCharge> charges,
      ...
      case PERCENT_OF_AMOUNT:
        if (loanCharge.isInstalmentFee()) {
          errorcode =
              "installment." +
              LoanApiConstants
                  .LOAN_CHARGE_CAN_NOT_BE_ADDED_WITH_PRINCIPAL_CALCULATION_TYPE;
        }
        break;
      case PERCENT_OF_AMOUNT_AND_INTEREST:
        if (loanCharge.isInstalmentFee()) {
          ...
          errorcode =
              "specific." +
              LoanApiConstants
                  .LOAN_CHARGE_CAN_NOT_BE_ADDED_WITH_INTEREST_CALCULATION_TYPE;
        }
        break;
  ...
  private void
  validatePartialPeriodSupport(final Integer interestCalculationPeriodType,
                               final DataValidatorBuilder baseDataValidator,
    ...
    if (interestCalculationPeriodType != null) {
      ...
      if (this.fromApiJsonHelper.parameterExists(
              LoanProductConstants
                  .ALLOW_PARTIAL_PERIOD_INTEREST_CALCUALTION_PARAM_NAME,
              element)) {
        ...
        boolean considerPartialPeriods = considerPartialInterestEnabled == null
                                             ? false
      ...
      if (!considerPartialPeriodUpdates) {
        if (loanProduct.isInterestRecalculationEnabled()) {
          baseDataValidator.reset()
              .parameter(LoanProductConstants
                             .IS_INTEREST_RECALCULATION_ENABLED_PARAMETER_NAME)
              .failWithCode(
                  "not.supported.for.selected.interest.calcualtion.type");
        }

        if (loanProduct.isMultiDisburseLoan()) {
          baseDataValidator.reset()
              .parameter(
                  LoanProductConstants.MULTI_DISBURSE_LOAN_PARAMETER_NAME)
              .failWithCode(
                  "not.supported.for.selected.interest.calcualtion.type");
        }
