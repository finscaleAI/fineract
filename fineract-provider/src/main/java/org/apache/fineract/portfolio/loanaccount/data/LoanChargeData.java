...
public class LoanChargeData {
  ...
  public static LoanChargeData template(
      final Collection<ChargeData> chargeOptions) {
    return new LoanChargeData(null, null, null, null, null, null, null, null,
                              chargeOptions, false, null, false, false, null,
                              null, null, null, null);
  }
  ...
  public static LoanChargeData newLoanChargeDetails(
      final Long chargeId, final String name, final CurrencyData currency,
      final BigDecimal amount, final BigDecimal percentage,
      final EnumOptionData chargeTimeType,
      final EnumOptionData chargeCalculationType, final boolean penalty,
      final EnumOptionData chargePaymentMode, final BigDecimal minCap,
      final BigDecimal maxCap) {
    return new LoanChargeData(null, chargeId, name, currency, amount,
                              percentage, chargeTimeType, chargeCalculationType,
                              null, penalty, chargePaymentMode, false, false,
                              null, minCap, maxCap, null, null);
  }

  public LoanChargeData(
      final Long id, final Long chargeId, final String name,
      final CurrencyData currency, final BigDecimal amount,
      final BigDecimal amountPaid, final BigDecimal amountWaived,
      final BigDecimal amountWrittenOff, final BigDecimal amountOutstanding,
      final EnumOptionData chargeTimeType, final LocalDate dueDate,
      final EnumOptionData chargeCalculationType, final BigDecimal percentage,
    ...
    if (amountOrPercentage == null) {
      if (chargeCalculationType != null &&
          chargeCalculationType.getId().intValue() > 1) {
  ...
  public LoanChargeData(
      final Long id, final LocalDate dueAsOfDate,
      final BigDecimal amountOutstanding, EnumOptionData chargeTimeType,
      final Long loanId,
      Collection<LoanInstallmentChargeData> installmentChargeData) {
    this.id = id;
    this.chargeId = null;
  ...
  public LoanChargeData(final Long id, final Long chargeId,
                        final LocalDate dueAsOfDate,
                        EnumOptionData chargeTimeType, final BigDecimal amount,
                        final BigDecimal amountAccrued,
                        final BigDecimal amountWaived, final boolean penalty) {
    this.id = id;
    this.chargeId = chargeId;
    this.name = null;
    this.currency = null;
  ...
  public LoanChargeData(final BigDecimal amountUnrecognized,
                        final LoanChargeData chargeData) {
  ...
  public LoanChargeData(final Long id, final LocalDate dueAsOfDate,
  ...
  public BigDecimal getAmountOutstanding() { return this.amountOutstanding; }
  ...
  public BigDecimal amountOrPercentage() { return this.amountOrPercentage; }
  ...
  public BigDecimal getAmountAccrued() { return this.amountAccrued; }

  public void updateAmountAccrued(BigDecimal amountAccrued) {
    this.amountAccrued = amountAccrued;
  }

  public Long getChargeId() { return this.chargeId; }

  public BigDecimal getAmountWaived() { return this.amountWaived; }

  public BigDecimal getAmountUnrecognized() { return this.amountUnrecognized; }
}
