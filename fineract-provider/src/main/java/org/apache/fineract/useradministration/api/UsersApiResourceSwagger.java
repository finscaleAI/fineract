...
final class UsersApiResourceSwagger {
  ...
  public static final class GetUsersResponse {
    ...
    @ApiModelProperty(example = "1") public Long id;
    @ApiModelProperty(example = "mifos") public String username;
    @ApiModelProperty(example = "1") public Long officeId;
    @ApiModelProperty(example = "Head Office") public String officeName;
    @ApiModelProperty(example = "App") public String firstname;
    @ApiModelProperty(example = "Administrator") public String lastname;
    @ApiModelProperty(example = "demomfi@mifos.org") public String email;
    @ApiModelProperty(example = "false") public Boolean passwordNeverExpires;
  ...
  public static final class PostUsersRequest {
    ...
    @ApiModelProperty(example = "newuser") public String username;
    @ApiModelProperty(example = "Test") public String firstname;
    @ApiModelProperty(example = "User") public String lastname;
    @ApiModelProperty(example = "whatever@mifos.org") public String email;
    @ApiModelProperty(example = "1") public Long officeId;
    @ApiModelProperty(example = "1") public Long staffId;
    @ApiModelProperty(example = "[2,3]") public String Roles;
    @ApiModelProperty(example = "true") public Boolean sendPasswordToEmail;
    @ApiModelProperty(example = "true") public Boolean isSelfServiceUser;
  }
  ...
  public static final class PostUsersResponse {
    ...
    @ApiModelProperty(example = "1") public Long officeId;
    @ApiModelProperty(example = "11") public Long resourceId;
  }
  ...
  public static final class PutUsersUserIdRequest {
    ...
    @ApiModelProperty(example = "Test") public String firstname;
    @ApiModelProperty(example = "window75") public String password;
    @ApiModelProperty(example = "window75") public String repeatPassword;
  }
