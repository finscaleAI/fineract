...
public class TomcatJdbcDataSourcePerTenantService
  ...
  public DataSource retrieveDataSource() {
    ...
    if (tenant != null) {
      ...
      synchronized (this.tenantToDataSourceMap) {
        // if tenantConnection information available switch to the appropriate
        // datasource for that tenant.
  ...
  private DataSource createNewDataSourceFor(
    ...
    String jdbcUrl = this.driverConfig.constructProtocol(
    ...
    // These are the properties for each Tenant DB; the same configuration is
    // also in src/main/resources/META-INF/spring/hikariDataSource.xml for the
    // all Tenants DB -->
