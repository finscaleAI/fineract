...
public class LoanWorkbookPopulator extends AbstractWorkbookPopulator {
  ...
  public void populate(Workbook workbook, String dateFormat) {
    ...
    setClientAndGroupDateLookupTable(
        loanSheet, clientSheetPopulator.getClients(),
        groupSheetPopulator.getGroups(), LoanConstants.LOOKUP_CLIENT_NAME_COL,
  ...
  private void setRules(Sheet worksheet, String dateFormat) {
    CellRangeAddressList officeNameRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.OFFICE_NAME_COL, LoanConstants.OFFICE_NAME_COL);
    CellRangeAddressList loanTypeRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.LOAN_TYPE_COL, LoanConstants.LOAN_TYPE_COL);
    CellRangeAddressList clientNameRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.CLIENT_NAME_COL, LoanConstants.CLIENT_NAME_COL);
    CellRangeAddressList productNameRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.PRODUCT_COL, LoanConstants.PRODUCT_COL);
    CellRangeAddressList loanOfficerRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.LOAN_OFFICER_NAME_COL,
        LoanConstants.LOAN_OFFICER_NAME_COL);
    CellRangeAddressList submittedDateRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.SUBMITTED_ON_DATE_COL,
        LoanConstants.SUBMITTED_ON_DATE_COL);
    CellRangeAddressList fundNameRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.FUND_NAME_COL, LoanConstants.FUND_NAME_COL);
    CellRangeAddressList principalRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.PRINCIPAL_COL, LoanConstants.PRINCIPAL_COL);
    CellRangeAddressList noOfRepaymentsRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.NO_OF_REPAYMENTS_COL, LoanConstants.NO_OF_REPAYMENTS_COL);
    CellRangeAddressList repaidFrequencyRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.REPAID_EVERY_FREQUENCY_COL,
        LoanConstants.REPAID_EVERY_FREQUENCY_COL);
    CellRangeAddressList loanTermRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.LOAN_TERM_COL, LoanConstants.LOAN_TERM_COL);
    CellRangeAddressList loanTermFrequencyRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.LOAN_TERM_FREQUENCY_COL,
        LoanConstants.LOAN_TERM_FREQUENCY_COL);
    CellRangeAddressList interestFrequencyRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.NOMINAL_INTEREST_RATE_FREQUENCY_COL,
        LoanConstants.NOMINAL_INTEREST_RATE_FREQUENCY_COL);
    CellRangeAddressList interestRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.NOMINAL_INTEREST_RATE_COL,
        LoanConstants.NOMINAL_INTEREST_RATE_COL);
    CellRangeAddressList amortizationRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.AMORTIZATION_COL, LoanConstants.AMORTIZATION_COL);
    CellRangeAddressList interestMethodRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.INTEREST_METHOD_COL, LoanConstants.INTEREST_METHOD_COL);
    CellRangeAddressList intrestCalculationPeriodRange =
        new CellRangeAddressList(1,
                                 SpreadsheetVersion.EXCEL97.getLastRowIndex(),
                                 LoanConstants.INTEREST_CALCULATION_PERIOD_COL,
                                 LoanConstants.INTEREST_CALCULATION_PERIOD_COL);
    CellRangeAddressList repaymentStrategyRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.REPAYMENT_STRATEGY_COL,
        LoanConstants.REPAYMENT_STRATEGY_COL);
    CellRangeAddressList arrearsToleranceRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
    ...
    CellRangeAddressList graceOnPrincipalPaymentRange =
        new CellRangeAddressList(1,
                                 ...
                                 LoanConstants.GRACE_ON_PRINCIPAL_PAYMENT_COL);
    CellRangeAddressList graceOnInterestPaymentRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.GRACE_ON_INTEREST_PAYMENT_COL,
        LoanConstants.GRACE_ON_INTEREST_PAYMENT_COL);
    CellRangeAddressList graceOnInterestChargedRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.GRACE_ON_INTEREST_CHARGED_COL,
        LoanConstants.GRACE_ON_INTEREST_CHARGED_COL);
    CellRangeAddressList approvedDateRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.APPROVED_DATE_COL, LoanConstants.APPROVED_DATE_COL);
    CellRangeAddressList disbursedDateRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.DISBURSED_DATE_COL, LoanConstants.DISBURSED_DATE_COL);
    CellRangeAddressList paymentTypeRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.DISBURSED_PAYMENT_TYPE_COL,
        LoanConstants.DISBURSED_PAYMENT_TYPE_COL);
    CellRangeAddressList repaymentTypeRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.REPAYMENT_TYPE_COL, LoanConstants.REPAYMENT_TYPE_COL);
    CellRangeAddressList lastrepaymentDateRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.LAST_REPAYMENT_DATE_COL,
        LoanConstants.LAST_REPAYMENT_DATE_COL);
    DataValidationHelper validationHelper =
        new HSSFDataValidationHelper((HSSFSheet)worksheet);

    CellRangeAddressList chargeOneNameRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.CHARGE_NAME_1, LoanConstants.CHARGE_NAME_1);
    CellRangeAddressList chargeOneAmountTypeRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.CHARGE_AMOUNT_TYPE_1, LoanConstants.CHARGE_AMOUNT_TYPE_1);

    CellRangeAddressList chargeTwoNameRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
        LoanConstants.CHARGE_NAME_2, LoanConstants.CHARGE_NAME_2);
    CellRangeAddressList chargeTwoAmountTypeRange = new CellRangeAddressList(
        1, SpreadsheetVersion.EXCEL97.getLastRowIndex(),
    ...
    DataValidationConstraint loanTypeConstraint =
        validationHelper.createExplicitListConstraint(new String[] {
            LoanConstants.LOAN_TYPE_INDIVIDUAL, LoanConstants.LOAN_TYPE_GROUP,
    ...
    DataValidationConstraint loanOfficerNameConstraint =
        validationHelper.createFormulaListConstraint(
            "INDIRECT(CONCATENATE(\"Staff_\",$A1))");
        ...
        validationHelper.createDateConstraint(
            ...
            "=IF(INDIRECT(CONCATENATE(\"START_DATE_\",$E1))>VLOOKUP($C1,$AR$2:$AT$" +
                (clientSheetPopulator.getClientsSize() +
                 groupSheetPopulator.getGroupsSize() + 1) +
    ...
    DataValidationConstraint approvalDateConstraint =
        validationHelper.createDateConstraint(
            DataValidationConstraint.OperatorType.BETWEEN, "=$G1", "=TODAY()",
            dateFormat);
    DataValidationConstraint disbursedDateConstraint =
        validationHelper.createDateConstraint(
            DataValidationConstraint.OperatorType.BETWEEN, "=$H1", "=TODAY()",
            dateFormat);
    ...
    DataValidationConstraint frequencyConstraint =
        validationHelper.createExplicitListConstraint(
            new String[] {"Days", "Weeks", "Months", "Semi Month"});
    DataValidationConstraint loanTermFrequencyConstraint =
        validationHelper.createExplicitListConstraint(
            new String[] {"Days", "Weeks", "Months"});
    DataValidationConstraint loanTermConstraint =
        validationHelper.createIntegerConstraint(
            DataValidationConstraint.OperatorType.GREATER_OR_EQUAL, "=$M1/$N1",
            "=$M1*$N1");
    ...
    DataValidationConstraint interestMethodConstraint =
        validationHelper.createExplicitListConstraint(
            new String[] {"Flat", "Declining Balance"});
    ...
    DataValidationConstraint repaymentStrategyConstraint =
        validationHelper.createExplicitListConstraint(
            new String[] {"Penalties, Fees, Interest, Principal order",
                          "HeavensFamily Unique", "Creocore Unique",
    ...
    DataValidationConstraint lastRepaymentDateConstraint =
        validationHelper.createDateConstraint(
            DataValidationConstraint.OperatorType.BETWEEN, "=$I1", "=TODAY()",
            dateFormat);
    ...
    DataValidation officeValidation = validationHelper.createValidation(
        officeNameConstraint, officeNameRange);
    ...
    DataValidation amortizationValidation = validationHelper.createValidation(
        amortizationConstraint, amortizationRange);
    DataValidation interestMethodValidation = validationHelper.createValidation(
        interestMethodConstraint, interestMethodRange);
    ...
    DataValidation paymentTypeValidation = validationHelper.createValidation(
        paymentTypeConstraint, paymentTypeRange);
    DataValidation repaymentTypeValidation = validationHelper.createValidation(
        paymentTypeConstraint, repaymentTypeRange);
    DataValidation submittedDateValidation = validationHelper.createValidation(
        submittedDateConstraint, submittedDateRange);
    DataValidation approvalDateValidation = validationHelper.createValidation(
        approvalDateConstraint, approvedDateRange);
    DataValidation disbursedDateValidation = validationHelper.createValidation(
        disbursedDateConstraint, disbursedDateRange);
    ...
    DataValidation noOfRepaymentsValidation = validationHelper.createValidation(
    ...
    DataValidation graceOnPrincipalPaymentValidation =
        validationHelper.createValidation(graceOnPrincipalPaymentConstraint,
                                          graceOnPrincipalPaymentRange);
    DataValidation graceOnInterestPaymentValidation =
        validationHelper.createValidation(graceOnInterestPaymentConstraint,
                                          graceOnInterestPaymentRange);
    DataValidation graceOnInterestChargedValidation =
        validationHelper.createValidation(graceOnInterestChargedConstraint,
    ...
    DataValidation chargeOneNameValidation = validationHelper.createValidation(
        chargeOneNameConstraint, chargeOneNameRange);
    ...
    DataValidation chargeTwoNameValidation = validationHelper.createValidation(
        chargeTwoNameConstraint, chargeTwoNameRange);
  ...
  private void setLayout(Sheet worksheet) {
    ...
    worksheet.setColumnWidth(LoanConstants.CLIENT_NAME_COL,
                             TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(LoanConstants.CLIENT_EXTERNAL_ID,
    ...
    writeString(LoanConstants.CLIENT_EXTERNAL_ID, rowHeader,
                "Client ExternalID");
    ...
    writeString(LoanConstants.DISBURSED_PAYMENT_TYPE_COL, rowHeader,
                "Payment Type*");
    ...
    writeString(LoanConstants.INTEREST_METHOD_COL, rowHeader,
                "Interest Method*");
    writeString(LoanConstants.INTEREST_CALCULATION_PERIOD_COL, rowHeader,
                "Interest Calculation Period*");
    writeString(LoanConstants.ARREARS_TOLERANCE_COL, rowHeader,
                "Arrears Tolerance");
    writeString(LoanConstants.REPAYMENT_STRATEGY_COL, rowHeader,
                "Repayment Strategy*");
    writeString(LoanConstants.GRACE_ON_PRINCIPAL_PAYMENT_COL, rowHeader,
                "Grace-Principal Payment");
    writeString(LoanConstants.GRACE_ON_INTEREST_PAYMENT_COL, rowHeader,
                "Grace-Interest Payment");
    writeString(LoanConstants.GRACE_ON_INTEREST_CHARGED_COL, rowHeader,
                "Interest-Free Period(s)");
    ...
    writeString(LoanConstants.CHARGE_AMOUNT_TYPE_1, rowHeader,
                "Charged Amount Type");
    ...
    writeString(LoanConstants.CHARGE_AMOUNT_TYPE_2, rowHeader,
                "Charged Amount Type");
    ...
    rowHeader.getCell(LoanConstants.FIRST_REPAYMENT_COL)
        .setCellStyle(doubleBorderStyle);
    rowHeader.getCell(LoanConstants.REPAYMENT_TYPE_COL)
        .setCellStyle(doubleBorderStyle);
  }
  ...
  private void setDefaults(Sheet worksheet) {
    ...
    for (Integer rowNo = 1; rowNo < 1000; rowNo++) {
      ...
      writeFormula(
          LoanConstants.CLIENT_EXTERNAL_ID, row,
          "IF(ISERROR(VLOOKUP($C" + (rowNo + 1) + ",$AR$2:$AS$" +
              (clientSheetPopulator.getClients().size() + 1) + ",2,FALSE)),"
              + "\"\",(VLOOKUP($C" + (rowNo + 1) + ",$AR$2:$AS$" +
              (clientSheetPopulator.getClients().size() + 1) + ",2,FALSE)))");
      ...
      writeFormula(LoanConstants.REPAID_EVERY_COL, row,
                   "IF(ISERROR(INDIRECT(CONCATENATE(\"REPAYMENT_EVERY_\",$E" +
                       ...
                       (rowNo + 1) + ")))");
      writeFormula(
          LoanConstants.REPAID_EVERY_FREQUENCY_COL, row,
      ...
      writeFormula(LoanConstants.LOAN_TERM_FREQUENCY_COL, row,
                   "IF(($O" + (rowNo + 1) + "=\"Semi Month\"), \"Months\", $O" +
                       (rowNo + 1) + ")");
      writeFormula(
          LoanConstants.NOMINAL_INTEREST_RATE_FREQUENCY_COL, row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"INTEREST_FREQUENCY_\",$E" +
              (rowNo + 1) +
              "))),\"\",INDIRECT(CONCATENATE(\"INTEREST_FREQUENCY_\",$E" +
              (rowNo + 1) + ")))");
      writeFormula(LoanConstants.NOMINAL_INTEREST_RATE_COL, row,
  ...
  private void setNames(Sheet worksheet) {
    ...
    officeGroup.setRefersToFormula(
        TemplatePopulateImportConstants.OFFICE_SHEET_NAME + "!$B$2:$B$" +
        (officeNames.size() + 1));
    ...
    for (Integer i = 0; i < officeNames.size(); i++) {
      ...
      Integer[] officeNameToBeginEndIndexesOfStaff =
          personnelSheetPopulator.getOfficeNameToBeginEndIndexesOfStaff().get(
              i);
      ...
      if (officeNameToBeginEndIndexesOfStaff != null) {
        loanOfficerName.setNameName(
            "Staff_" + officeNames.get(i).trim().replaceAll("[ )(]", "_"));
        loanOfficerName.setRefersToFormula(
            TemplatePopulateImportConstants.STAFF_SHEET_NAME + "!$B$" +
            officeNameToBeginEndIndexesOfStaff[0] + ":$B$" +
            officeNameToBeginEndIndexesOfStaff[1]);
      }
      if (officeNameToBeginEndIndexesOfClients != null) {
        clientName.setNameName(
            "Client_" + officeNames.get(i).trim().replaceAll("[ )(]", "_"));
        clientName.setRefersToFormula(
            TemplatePopulateImportConstants.CLIENT_SHEET_NAME + "!$B$" +
      ...
      if (officeNameToBeginEndIndexesOfGroups != null) {
        groupName.setNameName(
            "Group_" + officeNames.get(i).trim().replaceAll("[ )(]", "_"));
        groupName.setRefersToFormula(
            TemplatePopulateImportConstants.GROUP_SHEET_NAME + "!$B$" +
    ...
    productGroup.setRefersToFormula(
        TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$B$2:$B$" +
    ...
    fundGroup.setRefersToFormula(
        TemplatePopulateImportConstants.EXTRAS_SHEET_NAME + "!$B$2:$B$" +
    ...
    chargeGroup.setRefersToFormula(
        TemplatePopulateImportConstants.CHARGE_SHEET_NAME + "!$B$2:$B$" +
        (chargeSheetPopulator.getChargesSize() + 1));
    ...
    for (Integer i = 0; i < charges.size(); i++) {
      ...
      String chargeName =
          charges.get(i).getName().trim().replaceAll("[ )(]", "_");

      chargeColName.setNameName("CHARGE_NAME_" + chargeName);
      chargeColName.setRefersToFormula(
          TemplatePopulateImportConstants.CHARGE_SHEET_NAME + "!$B$" + (i + 2));

      chargeAmount.setNameName("CHARGE_AMOUNT_" + chargeName);
      chargeAmount.setRefersToFormula(
          TemplatePopulateImportConstants.CHARGE_SHEET_NAME + "!$C$" + (i + 2));

      chargeAmountType.setNameName("CHARGE_AMOUNT_TYPE_" + chargeName);
      chargeAmountType.setRefersToFormula(
          TemplatePopulateImportConstants.CHARGE_SHEET_NAME + "!$D$" + (i + 2));
    }
    ...
    paymentTypeGroup.setRefersToFormula(
        TemplatePopulateImportConstants.EXTRAS_SHEET_NAME + "!$D$2:$D$" +
    ...
    for (Integer i = 0; i < products.size(); i++) {
      ...
      if (products.get(i).getFundName() != null) {
        fundName.setRefersToFormula(
            TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$C$" +
            (i + 2));
      }
      principalName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$D$" +
          (i + 2));
      minPrincipalName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$E$" +
          (i + 2));
      maxPrincipalName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$F$" +
          (i + 2));
      noOfRepaymentName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$G$" +
          (i + 2));
      minNoOfRepayment.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$H$" +
          (i + 2));
      maxNoOfRepaymentName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$I$" +
          (i + 2));
      repaymentEveryName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$J$" +
          (i + 2));
      repaymentFrequencyName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$K$" +
          (i + 2));
      interestName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$L$" +
          (i + 2));
      minInterestName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$M$" +
          (i + 2));
      maxInterestName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$N$" +
          (i + 2));
      interestFrequencyName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$O$" +
          (i + 2));
      amortizationName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$P$" +
          (i + 2));
      interestTypeName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$Q$" +
          (i + 2));
      interestCalculationPeriodName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$R$" +
          (i + 2));
      transactionProcessingStrategyName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$T$" +
          (i + 2));
      arrearsToleranceName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$S$" +
          (i + 2));
      graceOnPrincipalPaymentName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$U$" +
          (i + 2));
      graceOnInterestPaymentName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$V$" +
          (i + 2));
      graceOnInterestChargedName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$W$" +
          (i + 2));
      startDateName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$X$" +
          (i + 2));
    }
  }
}
