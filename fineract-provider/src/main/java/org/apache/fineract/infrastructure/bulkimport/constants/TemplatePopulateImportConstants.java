...
public final class TemplatePopulateImportConstants {
  ...
  public static final String FIXED_DEPOSIT_TRANSACTION_SHEET_NAME =
  ...
  public static final String SAVINGS_TRANSACTION_SHEET_NAME =
      "SavingsTransaction";
  ...
  public static final String STATUS_DISBURSAL_REPAYMENT_FAILED =
      "Repayment failed";
  ...
  public static final String INTEREST_COMPOUNDING_PERIOD_QUARTERLY =
      "Quarterly";
  public static final String INTEREST_COMPOUNDING_PERIOD_SEMI_ANNUALLY =
      "Semi-Annual";
  ...
  public static final String RECURRING_DEPOSIT_PRODUCT_ENTITY_TYPE =
      "RECURRINGDEPOSITPRODUCT";
  public static final String FIXED_DEPOSIT_PRODUCT_ENTITY_TYPE =
      "FIXEDDEPOSITPRODUCT";
