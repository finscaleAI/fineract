...
INSERT INTO m_permission (`grouping`, code, entity_name, action_name, can_maker_checker)
        VALUES ('cash_mgmt', 'CREATE_TELLER', 'TELLER', 'CREATE', 1);
INSERT INTO m_permission (`grouping`, code, entity_name, action_name, can_maker_checker)
        VALUES ('cash_mgmt', 'UPDATE_TELLER', 'TELLER', 'CREATE', 1);
INSERT INTO m_permission (`grouping`, code, entity_name, action_name, can_maker_checker)
        VALUES ('cash_mgmt', 'ALLOCATECASHIER_TELLER', 'TELLER', 'ALLOCATE', 1);
INSERT INTO m_permission (`grouping`, code, entity_name, action_name, can_maker_checker)
        VALUES ('cash_mgmt', 'UPDATECASHIERALLOCATION_TELLER', 'TELLER', 'UPDATECASHIERALLOCATION', 1);
INSERT INTO m_permission (`grouping`, code, entity_name, action_name, can_maker_checker)
        VALUES ('cash_mgmt', 'DELETECASHIERALLOCATION_TELLER', 'TELLER', 'DELETECASHIERALLOCATION', 1);
INSERT INTO m_permission (`grouping`, code, entity_name, action_name, can_maker_checker)
        VALUES ('cash_mgmt', 'ALLOCATECASHTOCASHIER_TELLER', 'TELLER', 'ALLOCATECASHTOCASHIER', 1);
INSERT INTO m_permission (`grouping`, code, entity_name, action_name, can_maker_checker)
        VALUES ('cash_mgmt', 'SETTLECASHFROMCASHIER_TELLER', 'TELLER', 'SETTLECASHFROMCASHIER', 1);
INSERT INTO r_enum_value (enum_name, enum_id, enum_message_property, enum_value, enum_type)
        VALUES ('teller_status', 300, 'Active', 'Active', 0);
INSERT INTO r_enum_value (enum_name, enum_id, enum_message_property, enum_value, enum_type)
        VALUES ('teller_status', 400, 'Inactive', 'Inactive', 0);
INSERT INTO r_enum_value (enum_name, enum_id, enum_message_property, enum_value, enum_type)
        VALUES ('teller_status', 600, 'Closed', 'Closed', 0);
