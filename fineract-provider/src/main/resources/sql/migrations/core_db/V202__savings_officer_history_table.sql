...
CREATE TABLE `m_savings_officer_assignment_history` (
    ...
    CONSTRAINT `fk_m_savings_officer_assignment_history_0002` FOREIGN KEY (`savings_officer_id`) REFERENCES `m_staff` (`id`)) ENGINE = InnoDB DEFAULT CHARSET = utf8;

INSERT INTO m_permission (`grouping`, code, entity_name, action_name)
        VALUES ('portfolio', 'REMOVESAVINGSOFFICER_SAVINGSACCOUNT', 'SAVINGSACCOUNT', 'REMOVESAVINGSOFFICER');
INSERT INTO m_permission (`grouping`, code, entity_name, action_name)
        VALUES ('portfolio', 'UPDATESAVINGSOFFICER_SAVINGSACCOUNT', 'SAVINGSACCOUNT', 'UPDATESAVINGSOFFICER');
