...
INSERT INTO `m_appuser`
        VALUES (NULL, 0, 1, NULL, @interop_username, 'Interop', 'User', '5787039480429368bf94732aacc771cd0a3ea02bcf504ffe1185ab94213bc63a', 'email@email.com', b '0', b '1', b '1', b '1', b '1', CURDATE (), 0, b '0');
...
INSERT IGNORE INTO m_code (code_name, is_system_defined)
...
FROM
    m_code
WHERE
    code_name = 'PaymentType';

INSERT IGNORE INTO m_code_value (code_id, code_value, order_position)
        VALUES (@code_id, 'Money Transfer', 1);
INSERT IGNORE INTO m_payment_type (value, description, order_position)
        VALUES ('Money Transfer', 'Money Transfer', 1);
