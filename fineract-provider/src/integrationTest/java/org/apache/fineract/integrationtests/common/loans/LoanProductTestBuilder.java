...
public class LoanProductTestBuilder {
  ...
  public static final String
      RECALCULATION_FREQUENCY_TYPE_SAME_AS_REPAYMENT_PERIOD = "1";
  ...
  public static final String RECALCULATION_STRATEGY_RESCHEDULE_NEXT_REPAYMENTS =
      "1";
  public static final String
  ...
  public static final String RECALCULATION_COMPOUNDING_METHOD_INTEREST_AND_FEE =
      "3";
  ...
  public String build(final String chargeId) {
    ...
    map.put("isInterestRecalculationEnabled",
            this.isInterestRecalculationEnabled);
    if (this.isInterestRecalculationEnabled) {
      map.put("interestRecalculationCompoundingMethod",
    ...
    if (holdGuaranteeFunds != null) {
      ...
      if (this.holdGuaranteeFunds) {
        ...
        map.put("minimumGuaranteeFromGuarantor",
                this.minimumGuaranteeFromGuarantor);
        map.put("minimumGuaranteeFromOwnFunds",
  ...
  withNumberOfRepayments(final String numberOfRepayment) {
    this.numberOfRepayments = numberOfRepayment;
    return this;
  }

  public LoanProductTestBuilder
  withRepaymentTypeAsSemiMonth(final String firstSemiDate,
                               final String secondSemiDate) {
  ...
  public LoanProductTestBuilder
  withRepaymentAfterEvery(final String repaymentAfterEvery) {
  ...
  public LoanProductTestBuilder
  withinterestRatePerPeriod(final String interestRatePerPeriod) {
  ...
  public LoanProductTestBuilder
  withInArrearsTolerance(final String amountCanBeWaved) {
  ...
  public LoanProductTestBuilder
  withAccountingRuleAsCashBased(final Account[] account_list) {
  ...
  public LoanProductTestBuilder
  withAccountingRuleUpfrontAccrual(final Account[] account_list) {
  ...
  public LoanProductTestBuilder
  withAccountingRulePeriodicAccrual(final Account[] account_list) {
  ...
  private Map<String, String> getAccountMappingForCashBased() {
    ...
    for (int i = 0; i < this.accountList.length; i++) {
      if (this.accountList[i].getAccountType().equals(
  ...
  public LoanProductTestBuilder withAccounting(final String accountingRule,
                                               final Account[] account_list) {
    this.accountingRule = accountingRule;
    this.accountList = account_list;
    return this;
  }

  public LoanProductTestBuilder currencyDetails(final String digitsAfterDecimal,
  ...
  public LoanProductTestBuilder
  withRepaymentStrategy(final String transactionProcessingStrategy) {
  ...
  public LoanProductTestBuilder
  withOnHoldFundDetails(final String mandatoryGuarantee,
  ...
  public LoanProductTestBuilder withMoratorium(String principal,
                                               String interest) {
  ...
  public LoanProductTestBuilder
  withLoanProductConfiguration(JsonObject loanProductConfigurableAttributes) {
    this.allowAttributeOverrides = loanProductConfigurableAttributes;
    return this;
  }

  public LoanProductTestBuilder
  withVariableInstallmentsConfig(Boolean allowVariableInstallments,
