...
public class LoanApplicationTestBuilder {
  ...
  private static final Logger LOG =
      LoggerFactory.getLogger(LoanApplicationTestBuilder.class);
  ...
  @SuppressWarnings("rawtypes") private List<HashMap> disbursementData = null;
  ...
  public String build(final String clientID, final String groupID,
  ...
  private String build(final HashMap<String, Object> map,
                       final String loanProductId, final String savingsID) {
  ...
  withPrincipal(final String principalAmount) {
    this.principal = principalAmount;
    return this;
  }

  public LoanApplicationTestBuilder
  withLoanTermFrequency(final String loanToBePayedDuration) {
  ...
  public LoanApplicationTestBuilder
  withNumberOfRepayments(final String numberOfRepayments) {
    this.numberOfRepayment = numberOfRepayments;
    return this;
  }

  public LoanApplicationTestBuilder
  withRepaymentEveryAfter(final String repaymentPeriod) {
  ...
  public LoanApplicationTestBuilder
  withInterestRatePerPeriod(final String interestRate) {
  ...
  public LoanApplicationTestBuilder
  withExpectedDisbursementDate(final String expectedDisbursementDate) {
    this.expectedDisbursmentDate = expectedDisbursementDate;
    return this;
  }

  public LoanApplicationTestBuilder
  withSubmittedOnDate(final String loanApplicationSubmittedDate) {
  ...
  public LoanApplicationTestBuilder
  withPrincipalGrace(final String graceOnPrincipalPayment) {
    this.graceOnPrincipalPayment = graceOnPrincipalPayment;
    return this;
  }

  public LoanApplicationTestBuilder
  withInterestGrace(final String graceOnInterestPayment) {
    this.graceOnInterestPayment = graceOnInterestPayment;
    return this;
  }

  public LoanApplicationTestBuilder
  withTranches(final List<HashMap> disbursementData) {
    this.disbursementData = disbursementData;
    return this;
  }

  public LoanApplicationTestBuilder
  withwithRepaymentStrategy(final String transactionProcessingStrategy) {
    this.transactionProcessingID = transactionProcessingStrategy;
    return this;
  }

  public LoanApplicationTestBuilder
  withFirstRepaymentDate(final String firstRepaymentDate) {
    this.repaymentsStartingFromDate = firstRepaymentDate;
    return this;
  }

  public LoanApplicationTestBuilder
  withParentAccount(final String parentAccount) {
    this.isParentAccount = parentAccount;
    return this;
  }

  public LoanApplicationTestBuilder
  withApprovalFormData(final List<Map<String, Object>> approvalFormData) {
  ...
  public LoanApplicationTestBuilder
  withFixedEmiAmount(final String installmentAmount) {
    this.fixedEmiAmount = installmentAmount;
    return this;
  }

  public LoanApplicationTestBuilder
  withDatatables(final List<HashMap<String, Object>> datatables) {
