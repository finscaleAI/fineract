...
public class ClientSavingsIntegrationTest {
  ...
  public void testSavingsAccount() {
    ...
    final Integer savingsProductID = createSavingsProduct(
        this.requestSpec, this.responseSpec, MINIMUM_OPENING_BALANCE,
  ...
  public void testSavingsAccount_CLOSE_APPLICATION() {
    ...
    assertEquals(
        ...
        savingsAccountErrorData.get(0).get(
            CommonConstants.RESPONSE_ERROR_MESSAGE_CODE));

    withdrawBalance = "true";
    savingsStatusHashMap = this.savingsAccountHelper.closeSavingsAccount(
        savingsId, withdrawBalance);
  ...
  public void testSavingsAccount_WITH_ENFORCE_MIN_BALANCE() {
    ...
    final boolean allowOverdraft = false;
    final Integer savingsProductID = createSavingsProduct(
        this.requestSpec, this.responseSpec, openningBalance,
        minBalanceForInterestCalculation, minRequiredBalance,
        enforceMinRequiredBalance, allowOverdraft);
    Assert.assertNotNull(savingsProductID);
    ...
    final Integer savingsActivationChargeId = ChargesHelper.createCharges(
    ...
    this.savingsAccountHelper.addChargesForSavings(
        savingsId, savingsActivationChargeId, true);
    ...
    balance -= chargeAmt;
    assertEquals("Verifying opening Balance", balance,
    ...
    ArrayList<HashMap> savingsAccountErrorData =
        (ArrayList<HashMap>)validationErrorHelper.withdrawalFromSavingsAccount(
            savingsId, withdrawAmt, TRANSACTION_DATE,
    ...
    Integer depositTransactionId =
        (Integer)this.savingsAccountHelper.depositToSavingsAccount(
            savingsId, DEPOSIT_AMOUNT, TRANSACTION_DATE,
    ...
    Integer withdrawTransactionId =
        (Integer)this.savingsAccountHelper.withdrawalFromSavingsAccount(
            savingsId, withdrawAmt, TRANSACTION_DATE,
            CommonConstants.RESPONSE_RESOURCE_ID);
    ...
    assertEquals("Verifying Withdrawal Amount", new Float(withdrawAmt),
                 withdrawTransaction.get("amount"));
    assertEquals("Verifying Balance after Withdrawal", balance,
                 withdrawTransaction.get("runningBalance"));
  }
  ...
  public void testSavingsAccount_DELETE_APPLICATION() {
    ...
    SavingsAccountHelper savingsAccountHelperValidationError =
        new SavingsAccountHelper(this.requestSpec,
  ...
  public void testSavingsAccount_REJECT_APPLICATION() {
    ...
    error1 = savingsAccountHelperValidationError.rejectApplicationWithErrorCode(
    ...
    savingsStatusHashMap =
        this.savingsAccountHelper.rejectApplication(savingsId);
  ...
  public void testSavingsAccount_WITHDRAW_APPLICATION() {
    ...
    savingsStatusHashMap =
        this.savingsAccountHelper.withdrawApplication(savingsId);
  ...
  public void testSavingsAccountTransactions() {
    ...
    List<HashMap> error =
        (List)savingsAccountHelperValidationError.withdrawalFromSavingsAccount(
            savingsId, "100", SavingsAccountHelper.TRANSACTION_DATE,
            CommonConstants.RESPONSE_ERROR);
    ...
    Integer depositTransactionId =
        (Integer)this.savingsAccountHelper.depositToSavingsAccount(
            savingsId, DEPOSIT_AMOUNT, SavingsAccountHelper.TRANSACTION_DATE,
            CommonConstants.RESPONSE_RESOURCE_ID);
    HashMap depositTransaction =
        this.savingsAccountHelper.getSavingsTransaction(savingsId,
                                                        depositTransactionId);
    ...
    HashMap newWithdrawTransaction =
        this.savingsAccountHelper.getSavingsTransaction(
            savingsId, newWithdrawTransactionId);
    balance = balance + new Float(WITHDRAW_AMOUNT) -
              new Float(WITHDRAW_AMOUNT_ADJUSTED);
    assertEquals("Verifying adjusted Amount",
                 new Float(WITHDRAW_AMOUNT_ADJUSTED),
                 newWithdrawTransaction.get("amount"));
    assertEquals("Verifying Balance after adjust", balance,
                 newWithdrawTransaction.get("runningBalance"));
    summary = this.savingsAccountHelper.getSavingsSummary(savingsId);
    assertEquals("Verifying Adjusted Balance", balance,
                 summary.get("accountBalance"));
    withdrawTransaction = this.savingsAccountHelper.getSavingsTransaction(
        savingsId, withdrawTransactionId);
    Assert.assertTrue((Boolean)withdrawTransaction.get("reversed"));

    this.savingsAccountHelper.undoSavingsAccountTransaction(
        savingsId, newWithdrawTransactionId);
    newWithdrawTransaction = this.savingsAccountHelper.getSavingsTransaction(
        savingsId, withdrawTransactionId);
    Assert.assertTrue((Boolean)newWithdrawTransaction.get("reversed"));
    summary = this.savingsAccountHelper.getSavingsSummary(savingsId);
    balance += new Float(WITHDRAW_AMOUNT_ADJUSTED);
    assertEquals("Verifying Balance After Undo Transaction", balance,
                 summary.get("accountBalance"));

    error =
        (List)savingsAccountHelperValidationError.withdrawalFromSavingsAccount(
            savingsId, "5000", SavingsAccountHelper.TRANSACTION_DATE,
            CommonConstants.RESPONSE_ERROR);
    assertEquals(
        "error.msg.savingsaccount.transaction.insufficient.account.balance",
        error.get(0).get(CommonConstants.RESPONSE_ERROR_MESSAGE_CODE));
    ...
    error =
        (List)savingsAccountHelperValidationError.withdrawalFromSavingsAccount(
            savingsId, "5000", SavingsAccountHelper.getFutureDate(),
            CommonConstants.RESPONSE_ERROR);
    ...
    error =
        (List)savingsAccountHelperValidationError.withdrawalFromSavingsAccount(
            savingsId, "5000", SavingsAccountHelper.CREATED_DATE_MINUS_ONE,
            CommonConstants.RESPONSE_ERROR);
  ...
  public void testSavingsAccountCharges() {
    ...
    final ResponseSpecification erroResponseSpec =
        new ResponseSpecBuilder().build();
    this.savingsAccountHelper =
        new SavingsAccountHelper(this.requestSpec, this.responseSpec);
    final SavingsAccountHelper validationErrorHelper =
    ...
    final Integer withdrawalChargeId = ChargesHelper.createCharges(
        this.requestSpec, this.responseSpec,
    ...
    chargesPendingState =
        this.savingsAccountHelper.getSavingsCharges(savingsId);
    Assert.assertTrue(chargesPendingState == null ||
    ...
    ArrayList<HashMap> savingsAccountErrorData =
        (ArrayList<HashMap>)validationErrorHelper.inactivateCharge(
    ...
    SimpleDateFormat sdf =
        new SimpleDateFormat(CommonConstants.dateFormat, Locale.US);
    ...
    for (int i = 1; i <= n; i++) {
      this.savingsAccountHelper.payCharge(
          (Integer)savingsChargeForPay.get("id"), savingsId,
          ((Float)savingsChargeForPay.get("amount")).toString(),
          sdf.format(cal.getTime()));
      HashMap paidCharge = this.savingsAccountHelper.getSavingsCharge(
    ...
    Integer inactivatedChargeId =
        (Integer)this.savingsAccountHelper.inactivateCharge(
            annualSavingsChargeId, savingsId,
            CommonConstants.RESPONSE_RESOURCE_ID);
    assertEquals("Inactivated Savings Charges Id", annualSavingsChargeId,
                 inactivatedChargeId);
    ...
    final Integer monthlySavingsCharge =
    ...
    this.savingsAccountHelper.waiveCharge(
        (Integer)savingsChargeForWaive.get("id"), savingsId);
    HashMap waiveCharge = this.savingsAccountHelper.getSavingsCharge(
    ...
    this.savingsAccountHelper.waiveCharge(
        (Integer)savingsChargeForWaive.get("id"), savingsId);
    waiveCharge = this.savingsAccountHelper.getSavingsCharge(
        savingsId, (Integer)savingsChargeForWaive.get("id"));
    BigDecimal totalWaiveAmount = BigDecimal.valueOf(
        Double.valueOf((Float)savingsChargeForWaive.get("amount")));
    ...
    Integer depositTransactionId =
        (Integer)this.savingsAccountHelper.depositToSavingsAccount(
            savingsId, "100000", SavingsAccountHelper.TRANSACTION_DATE,
            CommonConstants.RESPONSE_RESOURCE_ID);
    ...
    LocalDate nextDueDate = new LocalDate((Integer)nextDueDates.get(0),
                                          (Integer)nextDueDates.get(1),
                                          (Integer)nextDueDates.get(2));
    LocalDate expectedNextDueDate =
        new LocalDate((Integer)dates.get(0), (Integer)dates.get(1),
                      (Integer)dates.get(2))
  ...
  public void testSavingsAccountWithOverdraft() {
    ...
    final Integer savingsProductID = createSavingsProduct(
        this.requestSpec, this.responseSpec, zeroOpeningBalance,
        minBalanceForInterestCalculation, minRequiredBalance,
        enforceMinRequiredBalance, allowOverdraft);
    Assert.assertNotNull(savingsProductID);
    ...
    final Integer lastDayOfMonth =
        todaysDate.getActualMaximum(Calendar.DAY_OF_MONTH);
    ...
    Integer withdrawTransactionId =
        (Integer)this.savingsAccountHelper.withdrawalFromSavingsAccount(
            savingsId, WITHDRAW_AMOUNT, ACTIVATION_DATE,
            CommonConstants.RESPONSE_RESOURCE_ID);
    HashMap withdrawTransaction =
        this.savingsAccountHelper.getSavingsTransaction(savingsId,
                                                        withdrawTransactionId);
     ...
     */
    final Float nominalAnnualInterest = Float.valueOf(
        accountDetails.get("nominalAnnualInterestRate").toString());
    ...
    actualInterestPosted =
        new Float(decimalFormat.format(actualInterestPosted));
  ...
  public void testSavingsAccountPostInterestOnLastDayWithOverdraft() {
    ...
    Integer depositTransactionId =
        (Integer)this.savingsAccountHelper.depositToSavingsAccount(
            savingsId, DEPOSIT_AMOUNT, WITHDRAWAL_DATE,
            CommonConstants.RESPONSE_RESOURCE_ID);
    HashMap depositTransaction =
        this.savingsAccountHelper.getSavingsTransaction(savingsId,
                                                        depositTransactionId);
    ...
    Float nominalAnnualInterest = Float.valueOf(
        accountDetails.get("nominalAnnualInterestRate").toString());
    ...
    accountDetailsPostInterestPosted =
        new Float(decimalFormat.format(accountDetailsPostInterestPosted));
    assertEquals("Verifying interest posted", interestPosted,
                 accountDetailsPostInterestPosted);
    ...
    nominalAnnualInterest = Float.valueOf(
        accountDetails.get("nominalAnnualInterestRate").toString());
    ...
    assertEquals("Verifying interest posted", interestPosted,
                 accountDetailsPostInterestPosted);
    System.out.println(
        "-----Post Interest As on Successfully Worked----------");
    ...
    if (Calendar.DAY_OF_MONTH >= 22) {
      ...
      interestCalculationDaysInYearType =
          (HashMap)accountDetails.get("interestCalculationDaysInYearType");
      daysInYear = Integer.valueOf(
          interestCalculationDaysInYearType.get("id").toString());
      interestRateInFraction = (nominalAnnualInterest / 100);
      perDay = (double)1 / (daysInYear);
      interestPerDay = interestRateInFraction * perDay;
    ...
    DateFormat lastTransactionDateFormat =
  ...
  public void testSavingsAccountPostInterestWithOverdraft() {
    ...
    final String POSTED_TRANSACTION_DATE =
        dateFormat.format(postedDate.getTime());
    ...
    HashMap accountDetailsPostInterest =
        this.savingsAccountHelper.getSavingsDetails(savingsId);
    summary = (HashMap)accountDetails.get("summary");
    ArrayList interestPostingTransaction =
        (ArrayList)((HashMap)((ArrayList)accountDetails.get("transactions"))
                        .get(0))
            .get("date");
    Float accountDetailsPostInterestPosted =
        Float.valueOf(summary.get("totalInterestPosted").toString());
    ...
    assertEquals("Verifying interest posted", interestPosted,
                 accountDetailsPostInterestPosted);
    System.out.println(
        "------Post Interest As On After doing a post interest Successfully worked--------");
    ...
    final String INTEREST_POSTING_DATE =
        dateFormat.format(interestPostingDate.getTime());
    ...
    if (TODYS_POSTING_DATE.equalsIgnoreCase(INTEREST_POSTING_DATE)) {
      ...
      validationErrorHelper
          .closeSavingsAccountPostInterestAndGetBackRequiredField(
              savingsId, withdrawBalance, CommonConstants.RESPONSE_ERROR,
              CLOSEDON_DATE);
    } else {
      final SavingsAccountHelper validationErrorHelper =
  ...
  public void testPostInterestAsOnSavingsAccountWithOverdraft() {
    ...
    // ResponseSpecBuilder().expectStatusCode(400).build(); final
    // SavingsAccountHelper validationErrorHelper = new
    ...
    final String POSTED_LAST_TRANSACTION_DATE =
        dateFormat.format(postedLastDate.getTime());
    ...
    this.savingsAccountHelper.postInterestAsOnSavings(
        savingsId, POSTED_LAST_TRANSACTION_DATE);
    HashMap accountLastDetails =
        this.savingsAccountHelper.getSavingsDetails(savingsId);
    summary = (HashMap)accountLastDetails.get("summary");
    Float actualLastInterestPosted =
        Float.valueOf(summary.get("totalInterestPosted").toString());

    final Float nominalLastAnnualInterest = Float.valueOf(
        accountDetails.get("nominalAnnualInterestRate").toString());
    ...
    DecimalFormat decimalLastFormat =
        new DecimalFormat("", new DecimalFormatSymbols(Locale.US));
    ...
    actualInterestPosted =
        new Float(decimalFormat.format(actualInterestPosted));
    assertEquals("Verifying interest posted", interestLastPosted,
                 actualInterestPosted);
    System.out.println("------Post Interest As On Successful Worked--------");
  }
  ...
  public void testSavingsAccount_WITH_WITHHOLD_TAX() {
    ...
    final Integer savingsProductID = createSavingsProduct(
        this.requestSpec, this.responseSpec, MINIMUM_OPENING_BALANCE,
        minBalanceForInterestCalculation, minRequiredBalance,
        enforceMinRequiredBalance, allowOverdraft, String.valueOf(taxGroupId),
        false);
    Assert.assertNotNull(savingsProductID);
    ...
    Float expected = (Float)summary.get("totalDeposits") +
  ...
  public void testSavingsAccount_WITH_WITHHOLD_TAX_DISABLE_AT_ACCOUNT_LEVEL() {
    ...
    final HashMap changes =
        this.savingsAccountHelper.updateSavingsAccountWithHoldTaxStatus(
            savingsId, false);
  ...
  public void testSavingsAccount_DormancyTracking()
    ...
    final Integer savingsChargeId = ChargesHelper.createCharges(
        this.requestSpec, this.responseSpec,
    ...
    SchedulerJobHelper jobHelper =
        new SchedulerJobHelper(this.requestSpec, this.responseSpec);
    jobHelper.executeJob("Update Savings Dormant Accounts");

    // VERIFY WITHIN PROVIDED RANGE DOESN'T INACTIVATE
    savingsStatusHashMap = SavingsStatusChecker.getStatusOfSavings(
        this.requestSpec, this.responseSpec, savingsList.get(0));
    SavingsStatusChecker.verifySavingsIsActive(savingsStatusHashMap);
    savingsStatusHashMap = SavingsStatusChecker.getSubStatusOfSavings(
        this.requestSpec, this.responseSpec, savingsList.get(0));
    SavingsStatusChecker.verifySavingsSubStatusNone(savingsStatusHashMap);
    HashMap summary =
        this.savingsAccountHelper.getSavingsSummary(savingsList.get(0));
    Float balance = 3000f;
    Float chargeAmt = 0f;
    balance -= chargeAmt;
    assertEquals("Verifying account Balance", balance,
                 summary.get("accountBalance"));
    ...
    depositTransactionId =
        (Integer)this.savingsAccountHelper.depositToSavingsAccount(
            savingsList.get(2), DEPOSIT_AMOUNT, TRANSACTION_DATE,
            CommonConstants.RESPONSE_RESOURCE_ID);
    savingsStatusHashMap = SavingsStatusChecker.getStatusOfSavings(
        this.requestSpec, this.responseSpec, savingsList.get(2));
    SavingsStatusChecker.verifySavingsIsActive(savingsStatusHashMap);
    ...
    assertEquals("Verifying account Balance", 2900f,
                 summary.get("accountBalance"));
    ...
    assertEquals("Verifying account Balance", 900f,
                 summary.get("accountBalance"));
  ...
  private HashMap activateSavingsAccount(final Integer savingsId,
                                         final String activationDate) {
    final HashMap status = this.savingsAccountHelper.activateSavingsAccount(
        savingsId, activationDate);
    return status;
  }
  ...
  private Integer createSavingsProduct(
      ...
      final String taxGroupId, boolean withDormancy) {
    System.out.println(
  ...
  private Integer createTaxGroup(final String percentage) {
    ...
    final Integer taxComponentId = TaxComponentHelper.createTaxComponent(
  ...
  public void testSavingsAccountBlockStatus() {
    ...
    SavingsStatusChecker.verifySavingsSubStatusIsDebitBlocked(
        savingsStatusHashMap);
    error =
        (List)savingsAccountHelperValidationError.withdrawalFromSavingsAccount(
            savingsId, "100", SavingsAccountHelper.TRANSACTION_DATE,
    ...
    depositTransactionId =
        (Integer)this.savingsAccountHelper.depositToSavingsAccount(
            savingsId, DEPOSIT_AMOUNT, SavingsAccountHelper.TRANSACTION_DATE,
            CommonConstants.RESPONSE_RESOURCE_ID);
    depositTransaction = this.savingsAccountHelper.getSavingsTransaction(
        savingsId, depositTransactionId);
    balance += new Float(DEPOSIT_AMOUNT);
    assertEquals("Verifying Deposit Amount", new Float(DEPOSIT_AMOUNT),
                 depositTransaction.get("amount"));
    ...
    SavingsStatusChecker.verifySavingsSubStatusIsCreditBlocked(
        savingsStatusHashMap);
    error = (List)savingsAccountHelperValidationError.depositToSavingsAccount(
        savingsId, "100", SavingsAccountHelper.TRANSACTION_DATE,
        CommonConstants.RESPONSE_ERROR);
    ...
    Integer holdTransactionId =
        (Integer)this.savingsAccountHelper.holdAmountInSavingsAccount(
            savingsId, String.valueOf(balance - 100),
            SavingsAccountHelper.TRANSACTION_DATE,
            CommonConstants.RESPONSE_RESOURCE_ID);
    error =
        (List)savingsAccountHelperValidationError.withdrawalFromSavingsAccount(
            savingsId, "300", SavingsAccountHelper.TRANSACTION_DATE_PLUS_ONE,
            CommonConstants.RESPONSE_ERROR);
    assertEquals(
        "error.msg.savingsaccount.transaction.insufficient.account.balance",
        error.get(0).get(CommonConstants.RESPONSE_ERROR_MESSAGE_CODE));
  ...
  public void testAccountBalanceAfterTransactionReversal() {
    ...
    Integer depositTransactionId =
        (Integer)this.savingsAccountHelper.depositToSavingsAccount(
            savingsId, "500", SavingsAccountHelper.TRANSACTION_DATE,
            CommonConstants.RESPONSE_RESOURCE_ID);
    ...
    final Integer chargeId =
        this.savingsAccountHelper.addChargesForSavingsWithDueDate(
            savingsId, savingsChargeId, SavingsAccountHelper.TRANSACTION_DATE,
            amount);

    Assert.assertNotNull(chargeId);

    final Integer payChargeId = this.savingsAccountHelper.payCharge(
        chargeId, savingsId, chargeAmount,
        SavingsAccountHelper.TRANSACTION_DATE);
